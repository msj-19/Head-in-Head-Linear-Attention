...
from .mask_gated_delta_rule_t import mask_gated_chunk_delta_rule,mask_fused_recurrent_gated_delta_rule
...
#     'mask_gated_chunk_delta_rule','mask_fused_recurrent_delta_rule',
# ]
